        ...
        <main>
            <div className="breadcrumb">
                <div className="gridrow">
                    <div className="col-12">
                        <a to="productlist.html" title="Tops">Tops</a> <i className="icn-chevron-right"></i>
                        <a to="productlist.html" title="Sweaters">Sweaters</a> <i className="icn-chevron-right"></i>
                       {product.name}
                    </div>
                </div>
            </div>
            <div className="gridrow" id="product">
                ...
                <div id="bigimg" className="col-9 col-t-4 col-d-5">
                    <img className="imgfit" srcSet={product.image+" 720w, "+product.image+" 640w"} sizes="(min-width: 1200px) 720px, 640px" src={product.image} />
                    <div className="share margintopfull">
                        Share this product 
                        <a to="#" title="Facebook"><i className="icn-facebook"></i></a>
                        <a to="#" title="Twitter"><i className="icn-twitter"></i></a>
                        <a to="#" title="Pinteres"><i className="icn-pinterest"></i></a>
                    </div>
                </div>
                  ...
                  <h1>{product.name}</h1>
                    ...
                    <div className="product-description-line gridrowfull">
                        ...
                        <div className="col-6 textright">
                            <a to="#" title="Size Guidelines" className="fancytext">Size Guidelines</a>
                        </div>
                        ...
                        <div className="col-12 col-d textright wishlist marginbottomtwothirds">
                            <a to="#" title="Add top wishlist" className="fancytext"><i className="icn-heart"></i> Add to wishlist</a>
                        </div>
                    </div>
